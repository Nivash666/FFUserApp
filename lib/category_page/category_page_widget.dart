...
class CategoryPageWidget extends StatefulWidget {
  const CategoryPageWidget({
    super.key,
    required this.shopidfromproductpage,
  });

  final ShopsRow? shopidfromproductpage;
                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child: FutureBuilder<ApiCallResponse>(
                        future: SampleapiCall.call(
                          vendorId: widget.shopidfromproductpage?.id,
                        ),
                        builder: (context, snapshot) {
                          ...
                          final gridViewSampleapiResponse = snapshot.data!;
                          return Builder(
                            builder: (context) {
                              final categoriesresponse =
                                  (gridViewSampleapiResponse.jsonBody
                                                  .toList()
                                                  .map<CategoriesTypeStruct?>(
                              ...
                              return GridView.builder(
                                ...
                                itemBuilder:
                                    (context, categoriesresponseIndex) {
                                  final categoriesresponseItem =
                                      categoriesresponse[
                                          categoriesresponseIndex];
                                  return Align(
                                    alignment: const AlignmentDirectional(0.0, 0.0),
                                    child: Padding(
